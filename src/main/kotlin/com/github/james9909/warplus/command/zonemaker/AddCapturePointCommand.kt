...
class AddCapturePointCommand : ZonemakerCommand() {
    override val usageString = "/$WARPLUS_BASE_COMMAND addcapturepoint <name>"
    override val description = "Create a capture point at the current location"
    ...
    override fun execute(plugin: WarPlus, sender: CommandSender, args: List<String>): Boolean {
        ...
        val message = when (val result = warzone.addCapturePointObjective(origin, args[0])) {
            is Ok -> "Capture point ${args[0]} created!"
